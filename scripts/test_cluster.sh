...
tmux send-keys -t iridium:client1 "RUST_LOG=debug iridium -P 2255 --node-alias client1" C-m
tmux send-keys -t iridium:client2 "RUST_LOG=debug iridium -P 2256 --node-alias client2" C-m
